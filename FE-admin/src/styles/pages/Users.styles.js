...
export const StatusBadge = styled.span`
  ...
  background: ${({ status }) => 
    ...
    status === 'banned' ? '#ffebee' : 
    '#fff3e0'};
  color: ${({ status }) => 
    status === 'active' ? '#2e7d32' : 
    status === 'banned' ? '#c62828' : 
    '#ed6c02'};
`;
...
export const UserDetailAvatar = styled(Avatar)`
  width: 120px;
  height: 120px;
  margin: 0 auto 16px;
`;
...
export const UserDetailRole = styled.div`
  margin-bottom: 16px;
`;

export const UserDetailStatus = styled.div`
  margin-bottom: 20px;
`;
